...
<section class="movie-list-section">
    <h2 class="section-title">책 리스트</h2>
    <div class="movie-grid">
    <?php foreach ($book as $content): ?>
        <a href="content_review.php?content_id=<?php echo htmlspecialchars($content['content_id']); ?>">
            <div class="movie-card">
                ...
                <div class="movie-info">
                    ...
                    <?php endif; ?>
                    <p><strong>저자:</strong> <?php echo htmlspecialchars($content['author']); ?></p>
                    <p><strong>장르:</strong> <?php echo htmlspecialchars($content['genre']); ?></p>
                    <p><strong>분량:</strong> <?php echo htmlspecialchars($content['duration']); ?>쪽</p>
                </div>
            </div>
        </a>
    <?php endforeach; ?>
