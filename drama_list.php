...
$sql = "
    ...
    GROUP BY 
        c.Content_ID, c.Title, c.Poster_Path, c.Director, c.GENRE, c.ACTORS, c.Duration
";
...
<section class="movie-list-section">
    <h2 class="section-title">드라마 리스트</h2>
    <div class="movie-grid">
    <?php foreach ($drama as $content): ?>
        <a href="content_review.php?content_id=<?php echo htmlspecialchars($content['content_id']); ?>">
            <div class="movie-card">
                ...
                <div class="movie-info">
                    ...
                    <?php endif; ?>
                    <p><strong>감독:</strong> <?php echo htmlspecialchars($content['director']); ?></p>
                    <p><strong>장르:</strong> <?php echo htmlspecialchars($content['genre']); ?></p>
                    <p><strong>출연:</strong> <?php echo htmlspecialchars($content['actors']); ?></p>
                    <p><strong>공개 회차:</strong> <?php echo htmlspecialchars($content['duration']); ?>회</p>
                </div>
            </div>
        </a>
    <?php endforeach; ?>
